...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadImage = findViewById(R.id.uploadnoticebutton);
        ...
        String[] items = new String[]{"Select Category", "republic Day", "Independence Day", "Festival","Other Events"};
